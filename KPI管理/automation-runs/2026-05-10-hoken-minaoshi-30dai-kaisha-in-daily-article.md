# 記事自動生成 バケツリレーログ: hoken-minaoshi-30dai-kaisha-in

- 実行日時: 2026-05-10T07:10:14.436Z
- slug: hoken-minaoshi-30dai-kaisha-in
- keyword: 保険 見直し 30代 会社員 タイミング
- type: guide
- category: 保険
- status: generated
- 文字数: 5,367字
...
| 工程 | 担当 | 成果物 | 判定 |
|---|---|---|---|
| 00 | TAKT | キュー入力を記事ブリーフ化 | OK |
| 01 | KEI/GAKU | KW・検索意図・差別化素材を生成プロンプトへ渡す | OK |
| 02 | YOMI | MDX本文・title・description・CTAを生成 | OK |
| 03 | TETSU | 文字数、PR表記、updatedDate、禁止表現、リスク表記を機械チェック | OK |
| 04 | AKIRA | 禁止表現と金融リスク表記の機械チェック | OK |
