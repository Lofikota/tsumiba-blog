...
TYPE_DESCRIPTIONS = {
    ...
    "型HENSHIN": "変身ストーリー。「昔の自分→転換点→今の自分」の時系列。編集部の借金200万→副業月20万→資産500万への変化を軸に。読者に「自分もできるかも」と思わせる。",
}

PERSONA = """
編集部（たなか れん）32歳・IT系会社員（SE）・東京在住
...
- 長文比較投稿：28本中4本まで
- 型HENSHIN（変身ストーリー）：28本中2本以上（編集部の変化を時系列で語る）
...
- 編集部の実際の変化を語る（借金200万 → 副業月20万 → 資産500万）
