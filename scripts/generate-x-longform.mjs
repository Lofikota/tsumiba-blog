...
2行: 選択肢を並べる
中盤: 判断軸を整理（なぜそちらか）
自分の答え: FX情報メディアtsumibaの中の人（build in public・架空の体験談禁止）としての選択を明かす
...
【編集部とは誰か】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
tsumiba（FX口座比較メディア）の編集部。実際に口座を開設し、スプレッド・約定・キャンペーン条件を比較検証して記事にしている。
架空の経歴・人生ストーリー・運用実績は語らない（架空個人ペルソナは2026-05-31に全廃）。
語ってよいのは、実際に行った検証・調査・公式情報の確認だけ。
...
【設計原則】
- 読者がヒーロー。編集部は「同じ道を先に通った先輩」として登場する
